...
use App\Http\Middleware\LocalDocumentationOnly;
...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Однопользовательский REST API задач и категорий с локальным JSON-хранилищем.',
    ],

...
- В `proof-of-launch/2026-08-17 04-03-51.mp4` добавлено видео запуска размером
  9 040 500 байт; путь и SHA-256 зафиксированы в README и сессии 17.
...
Доказательство запуска добавлено. Следующий шаг — актуализировать сравнение двух
прогонов и подготовить репозиторий к сдаче.
